...
subheadline{Feedbackgespräch 2 30.03.2026 - Fragenkatalog}
Frageblöcke
Verzweigung entfernen (MFA beruflich)
nix ankreuzen = weiß nicht

Faktorenanalyse  -> Analog zum Mapping (1) #adaptieren
Aspekte und Faktoren zusammenfügen um die Variablen zuzuordnen
--> Mittelwert der Beantwortung je Aspekt für die Quantifizierung
Windows-Vorlage checken
Umstrukturieren! Pro/Contra Diskutieren ... 
Hypothesen raus, Fragen anpassen und Struktur überprüfen
Zusatzfrage -> MFA vs. Passwort???

Action Plan für die Gliederung Neu:
1. Format anpassen
2. Mapping (1) adaptieren
3. Text an Fragen anpassen
4. Struktur überprüfen (ist die FF noch beantwortet?)
5. Umfrage auswerten
